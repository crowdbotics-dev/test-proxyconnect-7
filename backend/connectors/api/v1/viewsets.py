...
class proxtestconnectViewSet(BaseConnectorViewSet):
    PASSWORD = settings.PROXTESTCONNECT_PASSWORD
    USERNAME = settings.PROXTESTCONNECT_USERNAME
    BASE_URL = "https://api.testproxycont.com/1/"
    AUTH_TYPE = "basic"
    IDENTIFIER = "PROXTESTCONNECT"
    ...
    def tests(self, request, *args, **kwargs):
        ...
        data = self._api_call(
            "/tests", request_type="get", payload=payload, params=params
        )
